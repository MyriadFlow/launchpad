    ...
    return(
        <div className='w-full h-screen fixed top-0 right-0 bg-transparent inset-0 z-50 flex items-center justify-center'>
            <div className='xl:w-[710px] xl:h-[510px] w-[533px] h-[383px] bg-[#eeeded] rounded-md flex flex-col items-center justify-center gap-y-9 xl:gap-y-12 relative'>
                ...
                <button className='absolute top-0 right-0 p-4'><IoCloseOutline className='text-[24px] text-[#00000080]' /></button>
            </div>
        </div>
    );
}
...
const Step1: React.FC = () => {
  return (
    <div className='bg-[#AECDFE] xl:w-[1120px] w-[850px] xl:h-[920px] rounded-lg xl:px-8 xl:py-12 py-8 px-6 flex flex-col items-center xl:gap-x-8 gap-x-6 xl:mb-16 my-12'>
        ...
        <button className='xl:w-[216px] w-[162px] xl:h-12 h-9 border-black border-none rounded-full font-semibold xl:text-[18px] text-[14px] bg-buttonGradient xl:mt-16 mt-12 text-white'>Deploy TradeHub</button>
    </div>
  );
};
