...
const Form1: React.FC = () => {
  return (
    <div className='w-full bg-[#AECDFE] flex flex-col xl:gap-y-8 gap-y-6 xl:p-8 p-6 rounded-lg'>
      ...
      <div className='w-full flex xl:gap-x-8 gap-x-6'>
        <button className='flex-1 flex justify-center items-center w-full xl:h-[10rem] h-[7.5rem] border border-black border-dashed rounded-lg flex items-center justify-center gap-x-1'><IoAddSharp />Profile Image</button>
        <button className='flex-1 flex justify-center items-center w-full xl:h-[10rem] h-[7.5rem] border border-black border-dashed rounded-lg flex items-center justify-center gap-x-1'><IoAddSharp />Storefront Image</button>
      </div>
    </div>
  );
};
