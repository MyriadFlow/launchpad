import Image from '@/public/signature-series.png'
import React from "react";
import Button from "@/components/ui/Buttons/GeneralButton"

const header = 'Signature Series'
const paragraph = 'Delve into Signature Series, an exclusive assortment of ERC-721 NFTs, showcasing incomparable digital artworks, each imbued with a unique, unmistakable mark of authenticity'
